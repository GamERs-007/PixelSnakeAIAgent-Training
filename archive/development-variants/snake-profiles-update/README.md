...
features. The complete project inspected was `D:/isaac-lab/PixelSnake`; the
`snake-profiles-update` workspace copy has matching Python source but does not
include the complete project's `results/` and `models/` directories. Source paths
